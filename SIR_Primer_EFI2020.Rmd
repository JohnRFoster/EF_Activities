...
# Likelihood images/LikelihoodPrinciple.jpg
...
![Likelihood Principle: A model is more likely if it is the one for which the data are more probable. Here Hypothesis 2 is more likely to have generated the observed data point than Hypothesis 1]
